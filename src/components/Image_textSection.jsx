...
export default function Image_textSection({}) {
  return (
    <div className='flex flex-col-reverse items-center lg:flex-row h-auto py-16 lg:items-stretch gap-y-10 lg:gap-x-20 justify-center bg-gradient'>
     
     <div className='w-[90%] max-w-full lg:max-w-[40%]'>
        <Image
        title="About Us"
        path="/image2.jpg"
     ...
     <div className='lg:max-w-[45%] w-full'>
      <Fade direction='right' duration={1500} triggerOnce={true} cascade={true}>
       <SplitText
        ...
        <p className='leading-8 pt-4 text-[1.05rem] lg:hidden xl:block'>At Stellar Education System, we believe in nurturing confidence and critical thinking alongside academic success. Our goal is to equip students with the knowledge and skills they need to excel in their exams and beyond</p>
        </Fade>
     </div>
    </div>
  )
