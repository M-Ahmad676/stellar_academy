...
export default function Model({message}) {
  return (
    <div className='absolute top-[55%] left-[40%]  max-w-[23rem] w-full bg-white h-auto shadow-md shadow-gray-600 rounded-lg z-0 overflow-hidden'>
             ...
             { (() => {
              ...
              <button className='bg-amber-500 text-white max-w-[8rem] w-full py-1.5 rounded-md cursor-pointer hover:bg-orange-400'>{buttonText}</button>   
              </div> 
             )
              })()}
