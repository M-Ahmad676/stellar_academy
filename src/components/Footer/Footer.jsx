...
export default function Footer() {
  ...
  return (
    <div className="h-auto bg-gradient2 w-full py-20">
      <div className="w-[1400px] max-w-full grid grid-cols-[1.5fr_1fr_1fr_1fr] gap-x-10 justify-items-center place-content-center h-full">
